...
* 
*/
class Bogota_Model_Template_Template
{
	...
	public function getContentseccion($seccion){
		...
		return $this->_view->getRoutPHP("modules/bogota/Views/template/contenedor.php");
	}
	...
	public function banner($seccion){
		...
		return $this->_view->getRoutPHP("modules/bogota/Views/template/bannerprincipal.php");
	}
	...
	public function bannersimple($seccion){
		...
		return $this->_view->getRoutPHP("modules/bogota/Views/template/bannersimple.php");
	}
}