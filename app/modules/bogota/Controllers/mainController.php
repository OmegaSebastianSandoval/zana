...
class Bogota_mainController extends Controllers_Abstract
{
	...
	public function init()
	{
		...
		$this->template = new Bogota_Model_Template_Template($this->_view);
		...
		$header = $this->_view->getRoutPHP('modules/bogota/Views/partials/header.php');
		...
		$footer = $this->_view->getRoutPHP('modules/bogota/Views/partials/footer.php');
		$this->getLayout()->setData("footer",$footer);
		$adicionales = $this->_view->getRoutPHP('modules/bogota/Views/partials/adicionales.php');
