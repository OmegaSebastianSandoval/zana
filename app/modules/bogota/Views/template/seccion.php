					...
					<div class="<?php  echo $columna->contenido_columna; ?>   <?php if ($contenedor->contenido_id == 32  ||$contenedor->contenido_id == 48)  { ?>  columna-img-principal  <?php }   ?>  <?php if ($contenedor->contenido_id == 33 ||$contenedor->contenido_id == 32  ||$contenedor->contenido_id == 48 ||$contenedor->contenido_id == 49 )  { ?>  columna-img <?php }   ?>">
						<?php if ($columna->contenido_tipo == 5) { ?>
							...
							<?php if ($columna->contenido_disenio == 1) { ?>
								<?php include(APP_PATH . "modules/bogota/Views/template/disenio1.php"); ?>
							<?php } else if ($columna->contenido_disenio == 2) { ?>
								<?php include(APP_PATH . "modules/bogota/Views/template/disenio2.php"); ?>
							<?php } else if ($columna->contenido_disenio == 3) { ?>
								<?php include(APP_PATH . "modules/bogota/Views/template/disenio3.php"); ?>
							<?php } else if ($columna->contenido_disenio == 4) { ?>
								<?php include(APP_PATH . "modules/bogota/Views/template/disenio4.php"); ?>
							<?php } else if ($columna->contenido_disenio == 5) { ?>
								<?php include(APP_PATH . "modules/bogota/Views/template/disenio5.php"); ?>
							<?php } else if ($columna->contenido_disenio == 6) { ?>
								<?php include(APP_PATH . "modules/bogota/Views/template/disenio6.php"); ?>
							<?php } ?>
						<?php } else if ($columna->contenido_tipo == 6) { ?>
							<?php $carrousel = $rescolumna['hijos']; ?>
							<?php if ($columna->contenido_disenio == 1) { ?>
								<?php $disenio = APP_PATH . "modules/bogota/Views/template/disenio1.php"; ?>
							<?php } else if ($columna->contenido_disenio == 2) { ?>
								<?php $disenio = APP_PATH . "modules/bogota/Views/template/disenio2.php"; ?>
							<?php } else if ($columna->contenido_disenio == 3) { ?>
								<?php $disenio = APP_PATH . "modules/bogota/Views/template/disenio3.php"; ?>
							<?php } else if ($columna->contenido_disenio == 4) { ?>
								<?php $disenio = APP_PATH . "modules/bogota/Views/template/disenio4.php"; ?>
							<?php } else if ($columna->contenido_disenio == 5) { ?>
								<?php $disenio = APP_PATH . "modules/bogota/Views/template/disenio5.php"; ?>
							<?php } else if ($columna->contenido_disenio == 6) { ?>
								<?php $disenio = APP_PATH . "modules/bogota/Views/template/disenio6.php"; ?>
							<?php } ?>
							<div class="<?php if ($columna->contenido_columna_espacios == 1 || $columna->contenido_columna_espacios == 3) { ?>con-espacios<?php } ?>">
								<?php include(APP_PATH . "modules/bogota/Views/template/carrousel.php"); ?>
							</div>
						<?php } else if ($columna->contenido_tipo == 7) { ?>
							<?php $acordioncontent = $rescolumna['hijos']; ?>
							<?php include(APP_PATH . "modules/bogota/Views/template/acordion.php"); ?>
						<?php } else if ($columna->contenido_tipo == 8) { ?>
							<?php $slidercontent = $rescolumna['hijos']; ?>
							<?php include(APP_PATH . "modules/bogota/Views/template/slider.php"); ?>
						<?php } ?>
					</div>
				<?php endforeach ?>
			</div>
