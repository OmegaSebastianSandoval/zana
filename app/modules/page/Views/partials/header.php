  ...
  <div class="navbar  navbar-expand-lg">
    <div class="container">
       <ul class="nav d-flex justify-content-between w-100">
            ...
            <li class="nav-item">
              <a href="/page/hotel" class="link">Hotel</a>
            </li>
            <li class="nav-item">
              <a href="/page/ofertas" class="link">Ofertas</a>
            </li>
            <li class="nav-item">
              <a href="/page/galeria" class="link">Galería</a>
            </li>
            <li class="nav-item">
              <a href="/page/emprendimiento" class="link">Emprendimiento</a>
            </li>
            <li class="nav-item">
              <a href="/page/habitaciones" class="link">Habitaciones</a>
            </li>
          </ul> 
    </div>
  </div>
