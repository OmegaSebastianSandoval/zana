<div class="header headerCartagena ">
  ...
  <div class="navbar  navbar-expand-lg">
    <div class="container">
      <ul class="nav d-flex justify-content-between w-100">
        ...
        <li class="nav-item">
          <a href="/cartagena/hotel" class="link">Hotel</a>
        </li>
        <li class="nav-item">
          <a href="/cartagena/ofertas" class="link">Ofertas</a>
        </li>
        <li class="nav-item">
          <a href="/cartagena/galeria" class="link">Galería</a>
        </li>
        <li class="nav-item">
          <a href="/cartagena/emprendimiento" class="link">Emprendimiento</a>
        </li>
        <li class="nav-item">
          <a href="/cartagena/habitaciones" class="link">Habitaciones</a>
        </li>
      </ul>
    </div>
  </div>
