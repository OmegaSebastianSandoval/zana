...
class Cartagena_mainController extends Controllers_Abstract
{
	...
	public function init()
	{
		...
		$this->template = new Cartagena_Model_Template_Template($this->_view);
		...
		$header = $this->_view->getRoutPHP('modules/cartagena/Views/partials/header.php');
		...
		$footer = $this->_view->getRoutPHP('modules/cartagena/Views/partials/footer.php');
		$this->getLayout()->setData("footer",$footer);
		$adicionales = $this->_view->getRoutPHP('modules/cartagena/Views/partials/adicionales.php');
