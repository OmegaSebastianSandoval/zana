            ...
            <div class="row">
				<div class="col-3">
	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="imagenes_habitacion_habitacion">
	                        <option value="">Todas</option>
	                        <?php foreach ($this->list_imagenes_habitacion_habitacion as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'imagenes_habitacion_habitacion') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="imagenes_habitacion_titulo" value="<?php echo $this->getObjectVariable($this->filters, 'imagenes_habitacion_titulo') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Imagen</label>
		            ...
		            <input type="text" class="form-control" name="imagenes_habitacion_imagen" value="<?php echo $this->getObjectVariable($this->filters, 'imagenes_habitacion_imagen') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->imagenes_habitacion_id; ?>
					<tr>
						<td><?= $this->list_imagenes_habitacion_habitacion[$content->imagenes_habitacion_habitacion];?>
						<td><?=$content->imagenes_habitacion_titulo;?></td>
						<td>
							<?php if($content->imagenes_habitacion_imagen) { ?>
								<img src="/images/<?= $content->imagenes_habitacion_imagen; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->imagenes_habitacion_imagen; ?></div>
						</td>
						<td>
