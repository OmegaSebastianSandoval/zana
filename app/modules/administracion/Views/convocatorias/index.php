        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="convocatoria_titulo" value="<?php echo $this->getObjectVariable($this->filters, 'convocatoria_titulo') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Fecha</label>
		            ...
		            <input type="text" class="form-control" name="convocatoria_fecha" value="<?php echo $this->getObjectVariable($this->filters, 'convocatoria_fecha') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->convocatoria_id; ?>
					<tr>
						<td><?=$content->convocatoria_titulo;?></td>
						<td><?=$content->convocatoria_fecha;?></td>
						<td>
