				...
				<?php $id =  $content->contenido_id; ?>
					<tr>
						...
						<td class="text-right" style="min-width: 150px;">
							<div>
								<a class="btn btn-verde btn-sm" href="/administracion/imagenessostenibilidad?linea_id=<?= $id ?>"  data-bs-toggle="tooltip" data-placement="top" title="Imagenes/Videos"><i class="fa-solid fa-photo-film"></i></a>
