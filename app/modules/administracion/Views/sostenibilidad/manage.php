      ...
      <div class="row">
        ...
        <div class="col-12 form-group">
          ...
          <label class="input-group">
            ...
            <select name="contenido_fondo" id="" class="form-control">
              <option value="" selected disabled>Seleccione...</option>
              <option value="#FFFFFF" <?php if($this->content->contenido_fondo == '#FFFFFF'){ echo 'selected'; } ?>>Blanco</option>
              <option value="#F2F2F2" <?php if($this->content->contenido_fondo == '#F2F2F2'){ echo 'selected'; } ?>>Gris</option>
            </select>
          </label>
          <div class="help-block with-errors"></div>
        </div>
