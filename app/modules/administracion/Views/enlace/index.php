        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="enlaces_titulo" value="<?php echo $this->getObjectVariable($this->filters, 'enlaces_titulo') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Link</label>
		            ...
		            <input type="text" class="form-control" name="enlaces_link" value="<?php echo $this->getObjectVariable($this->filters, 'enlaces_link') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
