        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="frecuente_pregunta" value="<?php echo $this->getObjectVariable($this->filters, 'frecuente_pregunta') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->frecuente_id; ?>
					<tr>
						<td><?=$content->frecuente_pregunta;?></td>
						<td>
