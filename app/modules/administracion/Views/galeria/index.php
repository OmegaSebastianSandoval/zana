            ...
            <div class="row">
				...
				<div class="col-3">
	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="galeria_ciudad">
	                        <option value="">Todas</option>
	                        <?php foreach ($this->list_galeria_ciudad as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'galeria_ciudad') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
			...
			<tbody>
				...
				<?php $id =  $content->galeria_id; ?>
					<tr>
						...
						<td><?= $this->list_galeria_ciudad[$content->galeria_ciudad];?>
						<td>
