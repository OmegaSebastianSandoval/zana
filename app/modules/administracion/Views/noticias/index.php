        ...
        <div class="content-dashboard">
            <div class="row">
				...
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="noticia_imagen" value="<?php echo $this->getObjectVariable($this->filters, 'noticia_imagen') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
			...
			<tbody>
				...
				<?php $id =  $content->noticia_id; ?>
					<tr>
						...
						<td>
							<?php if($content->noticia_imagen) { ?>
								<img src="/images/<?= $content->noticia_imagen; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->noticia_imagen; ?></div>
						</td>
						<td>
