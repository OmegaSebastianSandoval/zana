        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="galeria_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'galeria_nombre') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Imagen</label>
		            ...
		            <input type="text" class="form-control" name="galeria_imagen" value="<?php echo $this->getObjectVariable($this->filters, 'galeria_imagen') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->galeria_id; ?>
					<tr>
						<td><?=$content->galeria_nombre;?></td>
						<td>
							<?php if($content->galeria_imagen) { ?>
								<img src="/images/<?= $content->galeria_imagen; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->galeria_imagen; ?></div>
						</td>
						<td>
						...
						<td class="text-right" style="min-width: 150px;">
							<div>
								<a class="btn btn-verde btn-sm" href="/administracion/imagenesgaleria?galeria_id=<?= $content->galeria_id ?>"  data-bs-toggle="tooltip" data-placement="top" title="Editar"><i class="fa-solid fa-images"></i></a>
