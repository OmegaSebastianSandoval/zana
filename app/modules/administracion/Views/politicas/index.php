        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="politica_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'politica_nombre') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="politica_seccion">
	                        <option value="">Todas</option>
	                        <?php foreach ($this->list_politica_seccion as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'politica_seccion') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->politica_id; ?>
					<tr>
						<td><?=$content->politica_nombre;?></td>
						<td><?= $this->list_politica_seccion[$content->politica_seccion];?>
						<td>
