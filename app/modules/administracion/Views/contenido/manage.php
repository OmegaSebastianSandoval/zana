			...
			<div class="row">
				...
				<?php if (($tipo != 4) || $this->contentpadre->contenido_tipo == 2) { ?>
					<div class="col-12 <?php if ($this->content->contenido_padre == 0) { ?>d-none <?php } ?> form-group no-colum">
						...
						<div class="row">
							...
							<div class="col-2">
								<label class="radio-col">
									<input type="radio" value="col-md-12 col-lg-4" <?php if ($this->content->contenido_columna == 'col-md-12 col-lg-4') { ?> checked <?php } ?> name="contenido_columna" id="contenido_columna" class="form-control">
									<span>
				...
				<?php if ($tipo == 5 || $tipo == 6 || $this->contentpadre->contenido_tipo == 2) { ?>
					<div class="col-10 form-group no-banner no-seccion si-carrousel no-acordion si-contenido2 " <?php if (($tipo != 2 && $tipo != 4 && $tipo != 5 && $tipo != 6) || $tipo == 0) { ?> style="display: none;" <?php } ?>>
						...
						<div class="row">
							...
							<div class="col-3 mb-2">
								<label class="radio-disenio">
									<input type="radio" value="6" <?php if ($this->content->contenido_disenio == '6') { ?> checked <?php } ?> name="contenido_disenio" id="contenido_disenio" class="form-control">
									<span>
										<img src="/skins/administracion/images/columna12.png">
									</span>
								</label>
				...
				<?php if ($padre  == 60) { ?>
					...
					<label class="input-group">
						...
						<select class="form-control" name="contenido_ciudad"  required >
							<option value="">Seleccione...</option>
							<?php foreach ($this->list_ciudad AS $key => $value ){?>
								<option <?php if($this->getObjectVariable($this->content,"contenido_ciudad") == $key ){ echo "selected"; }?> value="<?php echo $key; ?>" /> <?= $value; ?></option>
							<?php } ?>
						</select>
					</label>
					<div class="help-block with-errors"></div>
				...
				<div class="col-12 form-group no-banner no-carrousel no-seccion no-acordion si-contenido" <?php if ($tipo != 3) { ?> style="display: none;" <?php } ?>>
					...
					<textarea name="contenido_introduccion" id="contenido_introduccion" class="form-control tinyeditor" rows="10"><?php echo $this->content->contenido_introduccion; ?></textarea>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 form-group no-banner si-seccion si-contenido si-carrousel si-acordion si-contenido2 " <?php if (($tipo == 1 || $tipo == 0) && $this->contentpadre->contenido_tipo != 2) { ?> style="display: none;" <?php } ?>>
					...
					<textarea name="contenido_descripcion" id="contenido_descripcion" class="form-control tinyeditor" rows="10"><?php echo $this->content->contenido_descripcion; ?></textarea>
					<div class="help-block with-errors"></div>
				</div>
			</div>
