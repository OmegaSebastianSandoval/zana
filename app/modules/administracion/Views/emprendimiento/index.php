        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="emprendimiento_titulo" value="<?php echo $this->getObjectVariable($this->filters, 'emprendimiento_titulo') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Imagen</label>
		            ...
		            <input type="text" class="form-control" name="emprendimiento_imagen" value="<?php echo $this->getObjectVariable($this->filters, 'emprendimiento_imagen') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
					<label>Ciudad</label>
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="emprendimiento_ciudad">
	                        <option value="">Todas</option>
	                        <?php foreach ($this->list_emprendimiento_ciudad as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'emprendimiento_ciudad') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->emprendimiento_id; ?>
					<tr>
						<td><?=$content->emprendimiento_titulo;?></td>
						<td>
							<?php if($content->emprendimiento_imagen) { ?>
								<img src="/images/<?= $content->emprendimiento_imagen; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->emprendimiento_imagen; ?></div>
						</td>
						<td><?= $this->list_emprendimiento_ciudad[$content->emprendimiento_ciudad];?>
						<td>
