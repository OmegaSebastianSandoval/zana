        ...
        <div class="content-dashboard">
            <div class="row">
				...
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="imagen_imagen" value="<?php echo $this->getObjectVariable($this->filters, 'imagen_imagen') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
					<label>Galeria</label>
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="imagen_galeria">
	                        <option value="">Todas</option>
	                        <?php foreach ($this->list_imagen_galeria as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'imagen_galeria') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
			...
			<tbody>
				...
				<?php $id =  $content->imagen_id; ?>
					<tr>
						...
						<td>
							<?php if($content->imagen_imagen) { ?>
								<img src="/images/<?= $content->imagen_imagen; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->imagen_imagen; ?></div>
						</td>
						<td><?= $this->list_imagen_galeria[$content->imagen_galeria];?>
						<td>
