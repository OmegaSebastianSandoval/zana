        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="habitacion_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'habitacion_nombre') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
					<label>Ciudad</label>
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="habitacion_ciudad">
	                        <option value="">Todas</option>
	                        <?php foreach ($this->list_habitacion_ciudad as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'habitacion_ciudad') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
				<div class="col-3">
	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="habitacion_tipo">
	                        <option value="">Todas</option>
	                        <?php foreach ($this->list_habitacion_tipo as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'habitacion_tipo') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="habitacion_imagen" value="<?php echo $this->getObjectVariable($this->filters, 'habitacion_imagen') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->habitacion_id; ?>
					<tr>
						<td><?=$content->habitacion_nombre;?></td>
						<td><?= $this->list_habitacion_ciudad[$content->habitacion_ciudad];?>
						<td><?= $this->list_habitacion_tipo[$content->habitacion_tipo];?>
						<td>
							<?php if($content->habitacion_imagen) { ?>
								<img src="/images/<?= $content->habitacion_imagen; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->habitacion_imagen; ?></div>
						</td>
						<td class="text-right">
							<div>
