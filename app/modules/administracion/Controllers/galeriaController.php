...
class Administracion_galeriaController extends Administracion_mainController
{
	...
	{
		$title = "Aministración de Galeria";
		...
		$this->_view->list_galeria_ciudad = $this->getGaleriaciudad();
	}
	...
	private function getData()
	{
		...
		$data['galeria_nombre'] = $this->_getSanitizedParam("galeria_nombre");
		$data['galeria_ciudad'] = $this->_getSanitizedParam("galeria_ciudad");
		return $data;
	}
     ...
     */
	private function getGaleriaciudad()
	{
    ...
    protected function getFilter()
    {
        ...
        if (Session::getInstance()->get($this->namefilter)!="") {
            ...
            if ($filters->galeria_ciudad != '') {
                $filtros = $filtros." AND galeria_ciudad LIKE '%".$filters->galeria_ciudad."%'";
            }
		}
        return $filtros;
    }
    ...
    protected function filters()
    {
        if ($this->getRequest()->isPost()== true) {
            ...
            $parramsfilter = array();
					...
					$parramsfilter['galeria_ciudad'] =  $this->_getSanitizedParam("galeria_ciudad");Session::getInstance()->set($this->namefilter, $parramsfilter);
        }
