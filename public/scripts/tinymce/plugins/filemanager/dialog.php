...
<div class="uploader">
	...
	<div class="tabbable upload-tabbable"> <!-- Only required for left/right tabs -->
	    ...
	    <ul class="nav nav-tabs">
			<li class="active"><a href="#tab1"  data-bs-toggle="tab"><?php echo trans('Upload_base'); ?></a></li>
			<li><a href="#tab2" id="uploader-btn"  data-bs-toggle="tab"><?php echo trans('Upload_java'); ?></a></li>
	    </ul>
...
?>
            ...
            ?>		<figure data-name="<?php echo $file ?>" data-type="<?php if($is_img){ echo "img"; }else{ echo "file"; } ?>">
				...
				<figcaption>
				    ...
				    <a class="tip-right preview" title="<?php echo trans('Preview')?>" data-url="<?php echo $src;?>"  data-bs-toggle="lightbox" href="#previewLightbox"><i class=" icon-eye-open"></i></a>
